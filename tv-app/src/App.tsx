...
export default function App() {
  ...
  return (
    <div className="w-full h-screen overflow-hidden flex" style={{ background: 'var(--app-bg)' }}>
      ...
      <div className="w-[26vw] min-w-[360px] max-w-[440px] h-full border-l border-white/10 bg-black/10">
        <LeaderboardScreen compact />
      </div>
    </div>
  )
}

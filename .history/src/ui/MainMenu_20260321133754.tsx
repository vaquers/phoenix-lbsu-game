...
export function MainMenu() {
  ...
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-b from-sky-900/90 to-slate-900/95 text-white z-20" style={{ fontFamily: "'Soledago', sans-serif" }}>

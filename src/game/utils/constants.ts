...
// ── Камера ──────────────────────────────────────────────────────────────
export const CAMERA_OFFSET = [0, 5.1, -11.5] as const
export const CAMERA_LOOK_AHEAD = [0, 1.4, 12] as const
export const CAMERA_LERP_X = 0.08
export const CAMERA_LERP_Y = 0.05
export const CAMERA_LERP_Z = 0.07
...
export const OBSTACLE_SPAWN_INTERVAL_MAX = 1.4
export const OBSTACLE_SPAWN_DISTANCE = 20
...
// ── Платформы ───────────────────────────────────────────────────────────
export const PLATFORM_HEIGHTS = [1.0, 1.4, 2.0] as const
export const PLATFORM_LENGTH_MIN = 6
export const PLATFORM_LENGTH_MAX = 20
export const PLATFORM_WIDTH = 1.8
export const PLATFORM_SPAWN_CHANCE = 0.55
export const PLATFORM_SPAWN_Z_OFFSET = 95
export const PLATFORM_SPAWN_INTERVAL_MIN = 1.4
export const PLATFORM_SPAWN_INTERVAL_MAX = 3.0
export const PLATFORM_MIN_GAP = 12

...
const MERCH_CATALOG: MerchItem[] = [
  {
    id: 'merch-sticker-1',
    title: 'Phoenix Sticker Pack — Classic',
    description: 'Фирменные стикеры Phoenix для ноутбука и телефона.',
    image: '/merch/stikers_1.png',
    price: 30,
    available: true,
  },
  {
    id: 'merch-sticker-2',
    title: 'Phoenix Sticker Pack — Neon',
    description: 'Яркий набор стикеров, чтобы выделяться.',
    image: '/merch/stickers_2.png',
    price: 35,
    available: true,
  },
  {
    id: 'merch-sticker-3',
    title: 'Phoenix Sticker Pack — Vibe',
    description: 'Большой набор стикеров для фанатов Phoenix.',
    image: '/merch/sticker_3.png',
    price: 40,
    available: true,
  },
  {
    id: 'merch-keychain-1',
    title: 'Phoenix Брелок',
    description: 'Брелок с логотипом Phoenix — всегда под рукой.',
    image: '/merch/brelok_1.png',
    price: 60,
    available: true,
  },
  {
    id: 'merch-badge-1',
    title: 'Phoenix Значок — Classic',
    description: 'Металлический значок с фирменным стилем.',
    image: '/merch/znachok_1.png',
    price: 70,
    available: true,
  },
  {
    id: 'merch-badge-2',
    title: 'Phoenix Значок — Fire',
    description: 'Яркий значок Phoenix для рюкзака или куртки.',
    image: '/merch/znachok_2.png',
    price: 80,
    available: true,
  },
  {
    id: 'merch-joke-anton',
    title: 'Антон (люкс-экземпляр)',
    description: 'Коллекционный персонаж. Шутка дня. Не продаётся.',
    image: '/merch/anton.jpeg',
    price: 999999,
    available: true,
  },
  {
    id: 'merch-joke-kirill',
    title: 'Кирилл (ультра-редкий)',
    description: 'Редчайший экземпляр. Шутка. Купить невозможно.',
    image: '/merch/kirill.jpeg',
    price: 999999,
    available: true,
  },
]
